...
function Navbar() {
  ...
  return (
    <div className="relative z-50 flex items-center justify-between w-full h-16 px-6 bg-white shadow-md dark:bg-[#111827]">
      <div className="flex items-center justify-center text-xl font-semibold text-black dark:text-white">
        {" "}
      ...
      <div className="flex items-center space-x-4 md:hidden">
        ...
        {/* Hamburger Icon */}
        <div
          className="z-50 text-3xl text-black cursor-pointer dark:text-white"
          onClick={toggleMenu}
        >
          {isOpen ? <HiX /> : <HiMenu />}
        </div>
